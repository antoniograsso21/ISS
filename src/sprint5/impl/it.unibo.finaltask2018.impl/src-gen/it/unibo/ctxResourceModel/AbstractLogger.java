...
public abstract class AbstractLogger extends EventHandlerComponent { 
protected IEventItem event;
	public AbstractLogger(String name, QActorContext myCtx, IOutputEnvView outEnvView, String[] eventIds ) throws Exception {
