...
public abstract class AbstractEvt_obstacle extends EventHandlerComponent { 
protected IEventItem event;
	public AbstractEvt_obstacle(String name, QActorContext myCtx, IOutputEnvView outEnvView, String[] eventIds ) throws Exception {
	...
	public void handleCurrentEvent() throws Exception {
		...
		Term msgPattern = Term.createTerm("obstacleDetected(VALUE)");
				boolean b = this.pengine.unify(msgt, msgPattern);
				if( b ) {
			  		sendMsg("msg_obstacleDetected","resource_model_robot", QActorContext.dispatch, msgt.toString() ); 
				}else{
