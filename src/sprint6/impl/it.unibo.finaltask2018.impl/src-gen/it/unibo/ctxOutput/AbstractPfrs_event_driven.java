...
public abstract class AbstractPfrs_event_driven extends EventHandlerComponent { 
protected IEventItem event;
	public AbstractPfrs_event_driven(String name, QActorContext myCtx, IOutputEnvView outEnvView, String[] eventIds ) throws Exception {
	...
	public void handleCurrentEvent() throws Exception {
		...
		Term msgPattern = Term.createTerm("modelChanged(resource(NAME,STATE))");
				...
				if( b ) {
			  		sendMsg("msg_modelChanged","adapter_to_pfrs_mbot", QActorContext.dispatch, msgt.toString() ); 
				}else{
